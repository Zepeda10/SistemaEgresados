...
<div class="content text-center">
    <h2 class="mb-4">Agregar pregunta subencuesta</h2>

    <?php
     echo '<div class="d-flex flex-column">';
     echo '<form method="post" action="'.base_url().'admin/guardarPreguntaSubencuesta" class="form-inline">';
         echo '<div class="form-group mb-2">';

         echo '<label for="id_subencuesta" class="sr-only mt-2 mb-2">Subencuesta</label>';
         echo '<input type="text" class="form-control mx-auto" id="id_subencuesta" name="id_subencuesta" value="" style="width: 50%;">';
